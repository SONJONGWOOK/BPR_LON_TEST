...
public class AnnotationTreeData {
	 ...
	 */
	public AnnotationTreeData(String aName, String aValue, IFile aFile) { 
		name = aName;
		value = aValue;
		container = aFile; 
	} 
	...
	public boolean equals(Object obj) {
		return obj instanceof AnnotationTreeData
				&& ((AnnotationTreeData) obj).getName().equals(name);
	} 
